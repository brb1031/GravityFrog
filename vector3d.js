...
Vector3d.prototype.asRThetaPhi = function () {
    "use strict";
    return {r: this.getMagnitude(),
            theta: this.getTheta(),
            phi: Math.atan2(this.v[1], this.v[0])};
};
...
Vector3d.prototype.generateRandomUnitVector = function () {
    ...
    return new Vector3d(Math.cos(phi) * sintheta,
...
Vector3d.prototype.rotateMe = function (rotation) {
    "use strict";
    if (rotation.pivotPoint) {
        this.decrementMe(rotation.pivotPoint);
    }
    ...
    if (rotation.pivotPoint) {
        this.incrementMe(rotation.pivotPoint);
    }
    return this;
};
